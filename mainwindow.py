...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.selectedPrinterComboBox)
        ...
        self.printSelectedPushButton = QtWidgets.QPushButton(
            self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "Fishbowl Label Printer"))
        self.label.setText(_translate("MainWindow", "Printer:"))
        self.selectedPrinterComboBox.setToolTip(_translate(
            "MainWindow", "What Dymo printer to use. This is all printers available."))
        self.label_2.setText(_translate("MainWindow", "Label Template:"))
        self.labelFileLineEdit.setToolTip(_translate(
            "MainWindow", "File path to the .label file to use."))
        ...
        self.total_label.setText(_translate(
            "MainWindow", "Total Labels: VALUE"))
        self.selected_label_total.setText(
            _translate("MainWindow", "Selected Total: VALUE"))
        self.printSelectedPushButton.setText(
            _translate("MainWindow", "Print Selected"))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.actionMySQL_Settings.setText(
            _translate("MainWindow", "MySQL Settings"))
        self.actionMySQL_Settings.setToolTip(_translate(
            "MainWindow", "Settings for connecting to Fishbowls MySQL instance."))
        self.actionMySQL_Settings.setStatusTip(_translate(
            "MainWindow", "Settings for connecting to Fishbowls MySQL instance."))
